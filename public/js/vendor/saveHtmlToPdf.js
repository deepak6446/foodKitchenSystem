			...
			return {
				link : function(scope , element , attrs ) {
					...
					//	var elem = document.querySelectorAll('[pdf-save]') ;
						...
						x= x[1]+'-'+x[2]+'-'+x[3]+'-'+x[4]
						var broadcastedName = $rootScope.userInfo.user+'_'+x+'audit.pdf'|| 'default.pdf';
					...
					function convert(theElement , id) {
				        ...
				        html2canvas(quotes, {
				            ...
				            for (var i = 0; i <= quotes.clientHeight/980; i++) {
				                ...
				                var canvasDataURL = onePageCanvas.toDataURL("image/png", 4.0);
				            ...
				            $("#load").removeClass('loaderC loader')
				        }
				      });
